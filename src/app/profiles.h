...
const std::map<std::string, std::vector<std::string>> PROFILES {
    ...
    {"bce", {
            ...
            "MBP04", "MBP05", "MPB06", "MPB07",
            "MBP08", "MBP09", "MPB10", "MPB11",
            "MBP12", "MBP13", "MPB14", "MCP01",
            "MCP02", "MCH1X", "MCH2Y"
        }
    },
    {"bw2", {
    ...
    {"pkbhe", {
            ...
            "MHP21", "MHP22", "MWP23", "MHP24",
            "MHP25", "MHP26", "MWP27", "MHP28",
            "MHP29", "MHP30", "MWP31", "MHP32",
            "MHP33", "MHP34", "MWP41", "MHP42",
            "MHP35", "MHP36"
        }
    },
    {"pksinq", {
